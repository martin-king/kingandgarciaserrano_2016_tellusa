function reg(args)
*just used for writing the time series in ascii
*see the lines marked between asterisks below
...
while t<=te1
 'set t 't
 'd sum(tanom2dfih,y=8,y=12)'
  line=sublin(result,2)
  net=subwrd(line,4)
 'd sicanomfih'
  line=sublin(result,1)
  sicout=subwrd(line,4)
 cad=sicout'       'net
 rc=write('sic_nov_bsonet_aug.txt',cad,append)
 t=t+1
endwhile
*******
